<div class="footer-copyright-area">
    ...
    <!-- scrollUp JS
		============================================ -->
    <script src="{{asset('/public/admin')}}/js/wow/wow.min.js"></script>
    <!-- counterup JS
		============================================ -->
    ...
    <!-- jvectormap JS
		============================================ -->
    <script src="{{asset('/public/admin')}}/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="{{asset('/public/admin')}}/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="{{asset('/public/admin')}}/js/jvectormap/jvectormap-active.js"></script>
    <!-- peity JS
		============================================ -->
    ...
    <!-- flot JS
		============================================ -->
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.tooltip.min.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.spline.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.resize.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.pie.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.symbol.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/jquery.flot.time.js"></script>
    <script src="{{asset('/public/admin')}}/js/flot/dashtwo-flot-active.js"></script>
    <!-- data table JS
		============================================ -->
