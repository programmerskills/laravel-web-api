                            ...
                            <div class="sparkline11-list shadow-reset mg-t-30">
                                ...
                                <div class="sparkline11-graph">
                                    <div class="input-knob-dial-wrap">
                                        <div class="row">
                                            <form method="post" action="{{url('/admin/editchildcategory')}}/{{$details->id}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-lg-12">
                                                ...
                                                @if(!empty($subcategory))
                                                    @foreach($subcategory as $sub)
                                                        <option value="{{$sub->id}}" @if($sub->id==$details->subact_id){{"selected"}}@endif>{{ $sub->subcate }}</option>
                                                    @endforeach
                                                @endif    
                                                   </select>
                                                ...
                                                <div class="chosen-select-single mg-b-20">
                                                  ...
                                                  <input type="text" class="form-control" name="subchild_name" id="subchild_name" value="{{$details->subchild_name?$details->subchild_name :''}}">
                                                    <span style="color:red;">{{ $errors->first('subchild_name') }}</span>
                                                </div>

                                                <div class="chosen-select-single mg-b-20">
                                                    <label>Content</label>
                                                    <textarea class="form-control" id="content" name="content" rows="4">{{$details->content?$details->content :''}}</textarea>
                                                ...
                                                <div class="chosen-select-single mg-b-20">
                                                    ...
                                                    <br>
                                                    <img src="{{asset('/public/uploads/subchild')}}/{{$details->image?$details->image:''}}" alt="" height="40" width="40">
                                                </div>
                                                
                                                <input type="submit" value="Update Sub Childcategory" class="btn btn-primary">
                                            </div>
                                            </form>
                                        </div>
                                    </div>
